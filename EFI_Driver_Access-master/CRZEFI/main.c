...
efi_main(IN EFI_HANDLE ImageHandle, IN EFI_SYSTEM_TABLE *SystemTable) 
{
	...
	Print(L"\n");
	Print(L"  _____      _      __ __ __   _   _\n");
	Print(L" /   __|    / \    |__|  |__| | \ | |\n");
	Print(L" |  |      / _ \      |  |    |  \| |\n");
	Print(L" |  |__   / /_\ \   __|  |__  | |\  |\n");
	Print(L" \_____| /_/   \_\ |__|__|__| |_| \_|\n");
	Print(L"Redeveloped and Improved by Cain\n");
	Print(L"This cheat inserts an UD Driver into your OS through EFI to hide your cheat.\n");
	Print(L"If you have any questions, reach me at Cain#1464 on Discord.\n");
